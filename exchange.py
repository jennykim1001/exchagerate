...
def exchange_main():  
    ...
    currency_name = st.selectbox('통화 선택', currency_name_symbols.keys())
    ...
    if(clicked==True):
        ...
        last_page_num = 5 # 네이버 금융에서 가져올 최대 페이지 번호 지정
        ...
        st.dataframe(df_exchange_rate.head(15))  # 환율 데이터 표시(앞의 일부만 표시)
        ...
        # excel_data = df_exchange_rate.to_excel()
